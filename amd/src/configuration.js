...
/**
 * Tiny muai configuration
 *
 * @module     tiny_muai/configuration
 * @copyright  2026 Andrew Rowatt <A.J.Rowatt@massey.ac.nz>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

import {buttonName} from 'tiny_muai/common';
import {addToolbarButton, addMenubarItem} from 'editor_tiny/utils';

export const configure = (instanceConfig) => {
    // Update the instance configuration to add the muai option to the toolbar and menu.
    return {
